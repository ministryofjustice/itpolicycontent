...
investigations into malicious behaviour). MoJ will comply with all relevant legislation in its monitoring and auditing activities. MoJ provides you with 
computer equipment and systems to enable you to do your work. MoJ will exercise its rights to ensure that its computer equipment and systems are used in a legitimate and lawful manner. This applies equally to providers.
...
Unencrypted removable media holding OFFICIAL information must not be removed from secure

office premises without approval by a member of the Senior Civil Service and an approved business case.
